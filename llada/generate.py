...
# In an effort to debug the graph break caused by dual caching
...
def generate(model, prompt, steps=128, gen_length=128, block_length=128, temperature=0.,
    ...
    # NOTE: gen length and block_length control parallel generation. 
    # NOTE: if gen_length == block_length -> full parallel generation
    ...
    for num_block in range(num_blocks):
        ...
        while True:
            ...
            x[transfer_index] = x0[transfer_index] # this can be 0 if tokens do not exceed threshold
            i += 1
...
@torch.no_grad()
# TODO: this is still breaking. needs fix
